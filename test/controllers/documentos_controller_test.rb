...
class DocumentosControllerTest < ActionController::TestCase
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post :create, documento: { bloque: @documento.bloque, custodio: @documento.custodio, descripcion: @documento.descripcion, estado: @documento.estado, localidad: @documento.localidad, tipo: @documento.tipo, ubicacion: @documento.ubicacion }
    end
  ...
  test "should update documento" do
    patch :update, id: @documento, documento: { bloque: @documento.bloque, custodio: @documento.custodio, descripcion: @documento.descripcion, estado: @documento.estado, localidad: @documento.localidad, tipo: @documento.tipo, ubicacion: @documento.ubicacion }
    assert_redirected_to documento_path(assigns(:documento))
  end
